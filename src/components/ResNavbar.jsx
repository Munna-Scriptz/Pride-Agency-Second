...
const ResNavbar = () => {
    ...
    return (
        <>
            <nav className='lg:hidden block' data-aos="fade-down">
                <div className="container">
                    <div id="Navbar-Row" className='py-[15px] flex items-center justify-between'>
                        <div className='flex items-center justify-between' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-delay="800">
                            <Link to={'/'}><img className='w-[58px] z-50' src={Logo} alt="Logo" /></Link>
                        </div>
                        <div className='flex items-start gap-4' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-delay="1000">
                            {/* ---------Language Selector-------- */}
